...
def obtain_AOI(inputs: list, connecting_nodes: set):
    with open(f'Analyses/TGF/input')
        


def main():
    inputs = ['pta.tgf', 'bfn.tgf', 'cpt.tgf', 'dur.tgf', 'els.tgf', 'jnb.tgf', 'pzb.tgf', 'vdp.tgf']
    obtain_AOI(inputs, )
    ...
    inputs = ['pta.tgf', 'bfn.tgf', 'cpt.tgf', 'dur.tgf', 'els.tgf', 'jnb.tgf', 'pzb.tgf', 'vdp.tgf']
    obtain_AOI(inputs, connecting_nodes)
