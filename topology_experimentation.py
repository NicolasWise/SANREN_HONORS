...
def main():
    ...
    for size in Graph_sizes:  
        ...
        write_measure_to_csv(degree_centrality_dict, f'Analyses/Sample_Experimentation/degree_centrality_{sample_name}.csv', 'Degree Centrality')
        write_measure_to_csv(closeness_centrality_dict, f'Analyses//Sample_Experimentation/closeness_centrality_{sample_name}.csv', 'Closeness Centrality')
        write_measure_to_csv(betweeness_centrality_dict, f'Analyses//Sample_Experimentation/betweeness_centrality_{sample_name}.csv', 'Betweeness Centrality')
        ...
        write_measure_to_csv(top_betweeness_nodes, f'Analyses//Sample_Experimentation/top_r_betweeness_centrality_{sample_name}.csv', 'Betweeness Centrality')
        write_measure_to_csv(top_degree_nodes, f'Analyses//Sample_Experimentation/top_r_degree_centrality_{sample_name}.csv', 'Degree Centrality')
        write_measure_to_csv(top_closeness_nodes, f'Analyses//Sample_Experimentation/top_r_closeness_centrality_{sample_name}.csv', 'Closeness Centrality')
        ...
        write_measure_to_csv(top_core_numbers,f'Analyses//Sample_Experimentation/top_r_core_numbers_{sample_name}.csv', 'Core Number')
        write_measure_to_csv(top_core_influences,f'Analyses//Sample_Experimentation/top_r_core_influences_{sample_name}.csv', 'Core Influence')
        write_measure_to_csv(top_core_strengths,f'Analyses//Sample_Experimentation/top_r_core_strengths_{sample_name}.csv', 'Core Strength')
        # MUST CHANGE WRITING
